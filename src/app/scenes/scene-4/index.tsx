    ...
    return (
        <>
            <TextBox className="mt-60 mb-40" image={packageProfile} imagePosition="right">
                <p><Trans>Via het netwerk van postbedrijven komt het pakketje uiteindelijk bij Zoey aan.</Trans></p>
            </TextBox>
            <div className="flex container justify-center items-center gap-4 mx-auto">
                ...
                <TextBox>
                    <p><Trans>Zoey is erg blij met het pakketje van Opa Harry. Haar e-mailtje om Opa Kees te bedanken legt dezelfde afstand af in een oogwenk.</Trans></p>
                </TextBox>
            </div>
        </>
    );
