...
export default function Visualisations() {
    return (
        <div className="max-w-7xl mx-auto py-24 px-4">
            <h1 className="text-4xl font-bold text-center tracking-tighter"><Trans>Visualisaties van het internet</Trans></h1>
            <p className="text-center text-gray-500 text-2xl mt-8 max-w-2xl mx-auto"><Trans>Deze visualisaties helpen je beter te begrijpen hoe bepaalde aspecten van het internet in elkaar steken.</Trans></p>
            ...
            <h2 className="text-3xl font-bold tracking-tight text-center mt-40"><Trans>Mis je een visualisatie?</Trans></h2>
